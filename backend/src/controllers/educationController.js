/**
 * Security Education Module Controller
 * Static knowledge base — no DB needed
 */
...
const EDUCATION_DATA = {
  ...
  tips: [
    ...
    { category: '2FA',               tip: 'Use an authenticator app (Google Authenticator) over SMS when possible', icon: '📱' },
...
exports.getThreats = (req, res) => {
  res.json({ threats: EDUCATION_DATA.threats });
};
...
exports.getTips = (req, res) => {
  res.json({ tips: EDUCATION_DATA.tips });
};

exports.getGlossary = (req, res) => {
  res.json({ glossary: EDUCATION_DATA.glossary });
};
